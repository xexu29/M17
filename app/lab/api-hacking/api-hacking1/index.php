        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="#" method="post">
                    ...
                    <div class="mb-3 text-center">
                        <!-- <h4>  echo $strings['username']; ?> user</h4> BORREM QUE DIU L'USUARI I LA CONTRASENYA, JA QUE ES UNA VULNERABILITAT --> 
                        <!-- echo $strings['password'];  user</h4> BORREM QUE DIU L'USUARI I LA CONTRASENYA, JA QUE ES UNA VULNERABILITAT--> 
                    </div>
                </form>
            </div>
        </div>
