...
<head>
    ...
    <title><?php echo htmlspecialchars($strings['title']); ?></title> <!--Afegim htmlspecialchars per evitar errades Cross-site Scripting, PUEDE QUE TENGA QUE QUITAR ESTE-->
</head>
...
<body>
    <div class="alert alert-primary d-flex justify-content-center" style="text-align: center;width: fit-content;margin: auto;margin-top: 3vh;">
        <h6><?php echo htmlspecialchars($strings['text']); ?></h6> <!--Afegim htmlspecialchars per evitar errades Cross-site Scripting PUEDE QUE TENGA QUE QUITAR ESTE-->
    </div>
        ...
        <div class="wrapper col-md-6  shadow-lg" style="border-radius: 15px; margin-top: 4vh;">
            ...
            <div class="p-3 pb-0" style="text-align: center;">
                <form action="#" method="POST" style="margin: 0;">
                    <textarea placeholder="<?php echo htmlspecialchars($strings['message']); ?>" class="form-control" rows="3" name="mes"></textarea> <!--Afegim htmlspecialchars per evitar errades Cross-site Scripting.-->
                    <button type="submit" class="btn btn-primary m-3"><?php echo htmlspecialchars($strings['submit']); ?></button> <!--Afegim htmlspecialchars per evitar errades Cross-site Scripting.-->
                </form>
            </div>
        </div>
    </div>
    <form action="#" method="post">
       <button type="submit" name="del" class="btn btn-primary m-3"><?php echo htmlspecialchars($strings['delete']); ?></button> <!--Afegim htmlspecialchars per evitar errades Cross-site Scripting.-->
    </form>
