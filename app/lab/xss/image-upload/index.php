...
<body>
            ...
            <div class="row pt-5 mt-5 mb-3 d-flex justify-content-center">
                <div class="row col-md-4 text-center d-flex justify-content-center shadow-lg p-3 mb-5 rounded">
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="">
                            <label for="input_image" class="form-label mt-1"><?php echo htmlspecialchars($strings['text'], ENT_QUOTES, 'UTF-8'); ?></label> <!--Afegim htmlspecialchars per evitar errades Cross-site Scripting.-->
    ...
    <script id="VLBar" title="<?= htmlspecialchars($strings['title'], ENT_QUOTES, 'UTF-8'); ?>" category-id="1" src="/public/assets/js/vlnav.min.js"></script> <!--Afegim htmlspecialchars per evitar errades Cross-site Scripting.-->
</body>
